...
{
    Matrix4f ScaleTrans, RotateTrans, TranslationTrans, CameraTranslationTrans, CameraRotateTrans, PersProjTrans, Identity;
    ...
    Identity.InitTranslationTransform(0,0,0);
